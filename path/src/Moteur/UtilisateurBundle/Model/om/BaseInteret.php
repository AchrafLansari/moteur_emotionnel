...
abstract class BaseInteret extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Moteur\\UtilisateurBundle\\Model\\InteretPeer';
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = InteretPeer::ID;
        }
    ...
    public function setNom($v)
    {
        ...
        if ($this->nom !== $v) {
            $this->nom = $v;
            $this->modifiedColumns[] = InteretPeer::NOM;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = InteretPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Interet object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = InteretPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = InteretQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InteretPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(InteretPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(InteretPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }

        $sql = sprintf(
            'INSERT INTO `interet` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = InteretPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = InteretPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Interet'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Interet'][$this->getPrimaryKey()] = true;
        $keys = InteretPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNom(),
        );
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InteretPeer::ID)) $criteria->add(InteretPeer::ID, $this->id);
        if ($this->isColumnModified(InteretPeer::NOM)) $criteria->add(InteretPeer::NOM, $this->nom);
    ...
    {
        $criteria = new Criteria(InteretPeer::DATABASE_NAME);
        $criteria->add(InteretPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Interet (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Interet Clone of current object.
     * @throws PropelException
     */
    ...
    public function setUtilisateurInterets(PropelCollection $utilisateurInterets, PropelPDO $con = null)
    {
        ...
        foreach ($utilisateurInteretsToDelete as $utilisateurInteretRemoved) {
            $utilisateurInteretRemoved->setInteret(null);
        }
    ...
    protected function doAddUtilisateurInteret($utilisateurInteret)
    {
        ...
        $utilisateurInteret->setInteret($this);
    }
    ...
    public function removeUtilisateurInteret($utilisateurInteret)
    {
        if ($this->getUtilisateurInterets()->contains($utilisateurInteret)) {
            ...
            $utilisateurInteret->setInteret(null);
        }
     ...
     * @return PropelObjectCollection|UtilisateurInteret[] List of UtilisateurInteret objects
     */
    public function getUtilisateurInteretsJoinUtilisateur($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = UtilisateurInteretQuery::create(null, $criteria);
