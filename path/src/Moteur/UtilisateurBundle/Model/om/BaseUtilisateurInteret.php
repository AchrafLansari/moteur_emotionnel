...
abstract class BaseUtilisateurInteret extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Moteur\\UtilisateurBundle\\Model\\UtilisateurInteretPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        UtilisateurInteretPeer
     */
    ...
    /**
     * The value for the interet_id field.
     * @var        int
     */
    protected $interet_id;
    ...
    /**
     * Get the [interet_id] column value.
     *
     * @return int
     */
    public function getInteretId()
    {

        return $this->interet_id;
    }
     ...
     * @return UtilisateurInteret The current object (for fluent API support)
     */
    public function setUtilisateurId($v)
    {
        ...
        if ($this->utilisateur_id !== $v) {
            ...
            $this->modifiedColumns[] = UtilisateurInteretPeer::UTILISATEUR_ID;
        }
    ...
    /**
     * Set the value of [interet_id] column.
     *
     * @param  int $v new value
     * @return UtilisateurInteret The current object (for fluent API support)
     */
    public function setInteretId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->interet_id !== $v) {
            $this->interet_id = $v;
            $this->modifiedColumns[] = UtilisateurInteretPeer::INTERET_ID;
        }
    ...
    public function setValeur($v)
    {
        ...
        if ($this->valeur !== $v) {
            $this->valeur = $v;
            $this->modifiedColumns[] = UtilisateurInteretPeer::VALEUR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->interet_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->valeur = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = UtilisateurInteretPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating UtilisateurInteret object", $e);
        }
    }
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aInteret !== null && $this->interet_id !== $this->aInteret->getId()) {
            $this->aInteret = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = UtilisateurInteretPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = UtilisateurInteretQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                UtilisateurInteretPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UtilisateurInteretPeer::UTILISATEUR_ID)) {
            $modifiedColumns[':p' . $index++]  = '`utilisateur_id`';
        }
        if ($this->isColumnModified(UtilisateurInteretPeer::INTERET_ID)) {
            $modifiedColumns[':p' . $index++]  = '`interet_id`';
        }
        if ($this->isColumnModified(UtilisateurInteretPeer::VALEUR)) {
            $modifiedColumns[':p' . $index++]  = '`valeur`';
        }

        $sql = sprintf(
            'INSERT INTO `utilisateur_interet` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`utilisateur_id`':
                        ...
                        break;
                    case '`interet_id`':
                        $stmt->bindValue($identifier, $this->interet_id, PDO::PARAM_INT);
                        break;
                    case '`valeur`':
                        $stmt->bindValue($identifier, $this->valeur, PDO::PARAM_INT);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = UtilisateurInteretPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = UtilisateurInteretPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['UtilisateurInteret'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['UtilisateurInteret'][serialize($this->getPrimaryKey())] = true;
        $keys = UtilisateurInteretPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getUtilisateurId(),
            $keys[1] => $this->getInteretId(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setInteretId($arr[$keys[1]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UtilisateurInteretPeer::UTILISATEUR_ID)) $criteria->add(UtilisateurInteretPeer::UTILISATEUR_ID, $this->utilisateur_id);
        if ($this->isColumnModified(UtilisateurInteretPeer::INTERET_ID)) $criteria->add(UtilisateurInteretPeer::INTERET_ID, $this->interet_id);
        if ($this->isColumnModified(UtilisateurInteretPeer::VALEUR)) $criteria->add(UtilisateurInteretPeer::VALEUR, $this->valeur);
    ...
    {
        $criteria = new Criteria(UtilisateurInteretPeer::DATABASE_NAME);
        $criteria->add(UtilisateurInteretPeer::UTILISATEUR_ID, $this->utilisateur_id);
        $criteria->add(UtilisateurInteretPeer::INTERET_ID, $this->interet_id);
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getUtilisateurId()) && (null === $this->getInteretId());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of UtilisateurInteret (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setInteretId($this->getInteretId());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return UtilisateurInteret Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return UtilisateurInteretPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new UtilisateurInteretPeer();
        }
    ...
    {
        if ($v === null) {
            $this->setInteretId(NULL);
        } else {
            $this->setInteretId($v->getId());
        }
    ...
    {
        if ($this->aInteret === null && ($this->interet_id !== null) && $doQuery) {
            $this->aInteret = InteretQuery::create()->findPk($this->interet_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aInteret->addUtilisateurInterets($this);
             */
        }
    ...
    public function getUtilisateur(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUtilisateur === null && ($this->utilisateur_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUtilisateur->addUtilisateurInterets($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(UtilisateurInteretPeer::DEFAULT_STRING_FORMAT);
    }
