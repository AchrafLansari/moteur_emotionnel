...
/**
 * This class defines the structure of the 'profil_score_utilisateur_produit' table.
 *
 *
 *
 ...
 */
class ProfilScoreUtilisateurProduitTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'src.Moteur.RecommendationBundle.Model.map.ProfilScoreUtilisateurProduitTableMap';
    ...
    {
        // attributes
        $this->setName('profil_score_utilisateur_produit');
        $this->setPhpName('ProfilScoreUtilisateurProduit');
        $this->setClassname('Moteur\\RecommendationBundle\\Model\\ProfilScoreUtilisateurProduit');
...
} // ProfilScoreUtilisateurProduitTableMap
