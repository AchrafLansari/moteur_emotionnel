...
abstract class BaseProfilScoreRequeteUtilisateurProduit extends BaseObject
{
    /**
     * Peer class name
     */
    const PEER = 'Moteur\\RecommendationBundle\\Model\\ProfilScoreRequeteUtilisateurProduitPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProfilScoreRequeteUtilisateurProduitPeer
     */
     ...
     * @return ProfilScoreRequeteUtilisateurProduit The current object (for fluent API support)
     */
    public function setRequeteId($v)
    {
        ...
        if ($this->requete_id !== $v) {
            $this->requete_id = $v;
            $this->modifiedColumns[] = ProfilScoreRequeteUtilisateurProduitPeer::REQUETE_ID;
        }
    ...
    public function setUtilisateurId($v)
    {
        ...
        if ($this->utilisateur_id !== $v) {
            ...
            $this->modifiedColumns[] = ProfilScoreRequeteUtilisateurProduitPeer::UTILISATEUR_ID;
        }
    ...
    public function setProduitId($v)
    {
        ...
        if ($this->produit_id !== $v) {
            $this->produit_id = $v;
            $this->modifiedColumns[] = ProfilScoreRequeteUtilisateurProduitPeer::PRODUIT_ID;
        }
    ...
    public function setScore($v)
    {
        ...
        if ($this->score !== $v) {
            $this->score = $v;
            $this->modifiedColumns[] = ProfilScoreRequeteUtilisateurProduitPeer::SCORE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->utilisateur_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->produit_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            ...
            return $startcol + 4; // 4 = ProfilScoreRequeteUtilisateurProduitPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProfilScoreRequeteUtilisateurProduit object", $e);
        }
    }
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProfilScoreRequeteUtilisateurProduitPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProfilScoreRequeteUtilisateurProduitPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProfilScoreRequeteUtilisateurProduit'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProfilScoreRequeteUtilisateurProduit'][serialize($this->getPrimaryKey())] = true;
        $keys = ProfilScoreRequeteUtilisateurProduitPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getRequeteId(),
            $keys[1] => $this->getUtilisateurId(),
            $keys[2] => $this->getProduitId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfilScoreRequeteUtilisateurProduitPeer::REQUETE_ID)) $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::REQUETE_ID, $this->requete_id);
        if ($this->isColumnModified(ProfilScoreRequeteUtilisateurProduitPeer::UTILISATEUR_ID)) $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::UTILISATEUR_ID, $this->utilisateur_id);
        if ($this->isColumnModified(ProfilScoreRequeteUtilisateurProduitPeer::PRODUIT_ID)) $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::PRODUIT_ID, $this->produit_id);
        if ($this->isColumnModified(ProfilScoreRequeteUtilisateurProduitPeer::SCORE)) $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::SCORE, $this->score);
    ...
    {
        $criteria = new Criteria(ProfilScoreRequeteUtilisateurProduitPeer::DATABASE_NAME);
        $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::REQUETE_ID, $this->requete_id);
        $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::UTILISATEUR_ID, $this->utilisateur_id);
        $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::PRODUIT_ID, $this->produit_id);
        $criteria->add(ProfilScoreRequeteUtilisateurProduitPeer::SCORE, $this->score);
    ...
    public function getPrimaryKey()
    {
        ...
        $pks[1] = $this->getUtilisateurId();
        $pks[2] = $this->getProduitId();
        $pks[3] = $this->getScore();
    ...
    public function setPrimaryKey($keys)
    {
        ...
        $this->setUtilisateurId($keys[1]);
        $this->setProduitId($keys[2]);
        $this->setScore($keys[3]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getRequeteId()) && (null === $this->getUtilisateurId()) && (null === $this->getProduitId()) && (null === $this->getScore());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProfilScoreRequeteUtilisateurProduit (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProfilScoreRequeteUtilisateurProduit Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProfilScoreRequeteUtilisateurProduitPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProfilScoreRequeteUtilisateurProduitPeer();
        }
    ...
    public function setRequete(Requete $v = null)
    {
        ...
        if ($v !== null) {
            $v->addProfilScoreRequeteUtilisateurProduit($this);
        }
    ...
    public function getRequete(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aRequete === null && ($this->requete_id !== null) && $doQuery) {
            $this->aRequete = RequeteQuery::create()
                ->filterByProfilScoreRequeteUtilisateurProduit($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                ...
                $this->aRequete->addProfilScoreRequeteUtilisateurProduits($this);
             */
        }
    ...
    public function getUtilisateur(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUtilisateur === null && ($this->utilisateur_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aUtilisateur->addProfilScoreRequeteUtilisateurProduits($this);
             */
        }
    ...
    public function getProduit(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduit === null && ($this->produit_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduit->addProfilScoreRequeteUtilisateurProduits($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProfilScoreRequeteUtilisateurProduitPeer::DEFAULT_STRING_FORMAT);
    }
