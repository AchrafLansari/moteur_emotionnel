...
abstract class BaseProduitMotPoids extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'Moteur\\ProduitBundle\\Model\\ProduitMotPoidsPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProduitMotPoidsPeer
     */
     ...
     * @return ProduitMotPoids The current object (for fluent API support)
     */
    public function setMotId($v)
    {
        ...
        if ($this->mot_id !== $v) {
            $this->mot_id = $v;
            $this->modifiedColumns[] = ProduitMotPoidsPeer::MOT_ID;
        }
    ...
    public function setProduitId($v)
    {
        ...
        if ($this->produit_id !== $v) {
            $this->produit_id = $v;
            $this->modifiedColumns[] = ProduitMotPoidsPeer::PRODUIT_ID;
        }
    ...
    public function setPoids($v)
    {
        ...
        if ($this->poids !== $v) {
            $this->poids = $v;
            $this->modifiedColumns[] = ProduitMotPoidsPeer::POIDS;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->mot_id = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            $this->produit_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->poids = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = ProduitMotPoidsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ProduitMotPoids object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProduitMotPoidsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProduitMotPoidsQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProduitMotPoidsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProduitMotPoidsPeer::MOT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`mot_id`';
        }
        if ($this->isColumnModified(ProduitMotPoidsPeer::PRODUIT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`produit_id`';
        }
        if ($this->isColumnModified(ProduitMotPoidsPeer::POIDS)) {
            $modifiedColumns[':p' . $index++]  = '`poids`';
        }

        $sql = sprintf(
            'INSERT INTO `produit_mot_poids` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProduitMotPoidsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProduitMotPoidsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ProduitMotPoids'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ProduitMotPoids'][serialize($this->getPrimaryKey())] = true;
        $keys = ProduitMotPoidsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getMotId(),
            $keys[1] => $this->getProduitId(),
            $keys[2] => $this->getPoids(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setMotId($arr[$keys[0]]);
        if (array_key_exists($keys[1], $arr)) $this->setProduitId($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setPoids($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProduitMotPoidsPeer::MOT_ID)) $criteria->add(ProduitMotPoidsPeer::MOT_ID, $this->mot_id);
        if ($this->isColumnModified(ProduitMotPoidsPeer::PRODUIT_ID)) $criteria->add(ProduitMotPoidsPeer::PRODUIT_ID, $this->produit_id);
        if ($this->isColumnModified(ProduitMotPoidsPeer::POIDS)) $criteria->add(ProduitMotPoidsPeer::POIDS, $this->poids);
    ...
    {
        $criteria = new Criteria(ProduitMotPoidsPeer::DATABASE_NAME);
        $criteria->add(ProduitMotPoidsPeer::MOT_ID, $this->mot_id);
        $criteria->add(ProduitMotPoidsPeer::PRODUIT_ID, $this->produit_id);
        $criteria->add(ProduitMotPoidsPeer::POIDS, $this->poids);
    ...
    {
        $this->setMotId($keys[0]);
        $this->setProduitId($keys[1]);
        $this->setPoids($keys[2]);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return (null === $this->getMotId()) && (null === $this->getProduitId()) && (null === $this->getPoids());
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of ProduitMotPoids (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ProduitMotPoids Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProduitMotPoidsPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProduitMotPoidsPeer();
        }
    ...
    public function getMot(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aMot === null && ($this->mot_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aMot->addProduitMotPoidss($this);
             */
        }
    ...
    public function getProduit(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProduit === null && ($this->produit_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aProduit->addProduitMotPoidss($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ProduitMotPoidsPeer::DEFAULT_STRING_FORMAT);
    }
