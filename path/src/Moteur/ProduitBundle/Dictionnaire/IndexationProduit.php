...
class IndexationProduit{
	...
	//coefficient donnant plus de poids aux éléments de l'entete
	...
	/**
	 * Définit une liste de mots vides
	 ...
	 * 
	 * @param unknown $segments le tableau de mots à traiter
	 * @return un tableau sans les éléments n'ayant pas de sens
	 */
	 ...
	 * 
	 * @Param $segments le tableau de chaines de caractères
	 * @Param $taille la taille minimale des chaines de caractères
	 ...
	 * @Return un tableau de chaine de caract�res
	 */
	...
	/**
	 * Multiplie les valeurs d'un tableau cl� valeur par un coefficient
	 * 
