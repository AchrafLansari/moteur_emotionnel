...
abstract class BaseProduit extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Acme\\UserBundle\\Model\\ProduitPeer';
    ...
    /**
     * The value for the autheur field.
     * @var        string
     */
    protected $autheur;
    ...
    /**
     * Set the value of [autheur] column.
     *
     * @param  string $v new value
     * @return Produit The current object (for fluent API support)
     */
    public function setAutheur($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->autheur !== $v) {
            $this->autheur = $v;
            $this->modifiedColumns[] = ProduitPeer::AUTHEUR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->autheur = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProduitPeer::NOM)) {
            $modifiedColumns[':p' . $index++]  = '`nom`';
        }
        if ($this->isColumnModified(ProduitPeer::AUTHEUR)) {
            $modifiedColumns[':p' . $index++]  = '`autheur`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`nom`':
                        ...
                        break;
                    case '`autheur`':
                        $stmt->bindValue($identifier, $this->autheur, PDO::PARAM_STR);
                        break;
                    case '`description`':
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setAutheur($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProduitPeer::AUTHEUR)) $criteria->add(ProduitPeer::AUTHEUR, $this->autheur);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAutheur($this->getAutheur());
