...
use Acme\UserBundle\Model\map\UtilisateurTableMap;
...
abstract class BaseUtilisateurPeer
{
    ...
    const OM_CLASS = 'Acme\\UserBundle\\Model\\Utilisateur';

    /** the related TableMap class for this table */
    const TM_CLASS = 'Acme\\UserBundle\\Model\\map\\UtilisateurTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Nom', 'Prenom', 'Age', 'Ville', 'Ip', 'Description', 'CategorieId', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nom', 'prenom', 'age', 'ville', 'ip', 'description', 'categorieId', ),
        BasePeer::TYPE_COLNAME => array (UtilisateurPeer::ID, UtilisateurPeer::NOM, UtilisateurPeer::PRENOM, UtilisateurPeer::AGE, UtilisateurPeer::VILLE, UtilisateurPeer::IP, UtilisateurPeer::DESCRIPTION, UtilisateurPeer::CATEGORIE_ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOM', 'PRENOM', 'AGE', 'VILLE', 'IP', 'DESCRIPTION', 'CATEGORIE_ID', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nom', 'prenom', 'age', 'ville', 'ip', 'description', 'categorie_id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Nom' => 1, 'Prenom' => 2, 'Age' => 3, 'Ville' => 4, 'Ip' => 5, 'Description' => 6, 'CategorieId' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nom' => 1, 'prenom' => 2, 'age' => 3, 'ville' => 4, 'ip' => 5, 'description' => 6, 'categorieId' => 7, ),
        BasePeer::TYPE_COLNAME => array (UtilisateurPeer::ID => 0, UtilisateurPeer::NOM => 1, UtilisateurPeer::PRENOM => 2, UtilisateurPeer::AGE => 3, UtilisateurPeer::VILLE => 4, UtilisateurPeer::IP => 5, UtilisateurPeer::DESCRIPTION => 6, UtilisateurPeer::CATEGORIE_ID => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOM' => 1, 'PRENOM' => 2, 'AGE' => 3, 'VILLE' => 4, 'IP' => 5, 'DESCRIPTION' => 6, 'CATEGORIE_ID' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nom' => 1, 'prenom' => 2, 'age' => 3, 'ville' => 4, 'ip' => 5, 'description' => 6, 'categorie_id' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UtilisateurPeer::IP);
            $criteria->addSelectColumn(UtilisateurPeer::DESCRIPTION);
            $criteria->addSelectColumn(UtilisateurPeer::CATEGORIE_ID);
        } else {
    ...
    public static function doCountJoinCategorie(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(UtilisateurPeer::CATEGORIE_ID, CategoriePeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Utilisateur objects pre-filled with their Categorie objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinCategorie(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Utilisateur) to $obj2 (Categorie)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Utilisateur) to the collection in $obj2 (Categorie)
                $obj2->addUtilisateur($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseUtilisateurPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \Acme\UserBundle\Model\map\UtilisateurTableMap());
      }
    }
