...
abstract class BaseUtilisateur extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Acme\\UserBundle\\Model\\UtilisateurPeer';
    ...
    public function setIp($v)
    {
        ...
        if ($this->ip !== $v) {
            $this->ip = $v;
            $this->modifiedColumns[] = UtilisateurPeer::IP;
        }
    ...
    public function setCategorieId($v)
    {
        ...
        if ($this->categorie_id !== $v) {
            $this->categorie_id = $v;
            $this->modifiedColumns[] = UtilisateurPeer::CATEGORIE_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->age = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            ...
            $this->categorie_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->resetModified();
            ...
            return $startcol + 8; // 8 = UtilisateurPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UtilisateurPeer::IP)) {
            $modifiedColumns[':p' . $index++]  = '`ip`';
        }
        if ($this->isColumnModified(UtilisateurPeer::DESCRIPTION)) {
            $modifiedColumns[':p' . $index++]  = '`description`';
        }
        if ($this->isColumnModified(UtilisateurPeer::CATEGORIE_ID)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[7], $arr)) $this->setCategorieId($arr[$keys[7]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UtilisateurPeer::IP)) $criteria->add(UtilisateurPeer::IP, $this->ip);
        if ($this->isColumnModified(UtilisateurPeer::DESCRIPTION)) $criteria->add(UtilisateurPeer::DESCRIPTION, $this->description);
        if ($this->isColumnModified(UtilisateurPeer::CATEGORIE_ID)) $criteria->add(UtilisateurPeer::CATEGORIE_ID, $this->categorie_id);
    ...
    public function getCategorie(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aCategorie === null && ($this->categorie_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategorie->addUtilisateurs($this);
             */
        }
